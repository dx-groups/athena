...
if (config.serviceWorker) {
  ...
  webpackConfig.plugins.push(new WorkBoxPlugin.InjectManifest({ swSrc: config.serviceWorker.swSrc }))

  webpackConfig.plugins.push(new SwRegisterWebpackPlugin({ version: +new Date() }))
}
